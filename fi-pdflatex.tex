...
\usetheme[faculty=fi,logo=tudelft_white]{fibeamer}
\usepackage[utf8]{inputenc}
\usepackage[main=english]{babel}

%% These macros specify information about the presentation
\title{Introduction to Git(Hub)} %% that will be typeset on the
\subtitle{2024--11--12} %% title page.
...
\begin{figure}
	...
	\node[repository] at (0,0) (server) {Server};
...
\begin{figure}
	...
	\node[repository] at (0,0) (server1) {Server (GitHub)};
...
% No ``main'' server. All repositories are, actually, equal.
% \begin{figure}
% 	\begin{tikzpicture}
% 	\tikzstyle{repository}=[rectangle, draw, burntorange, rounded corners,
% 	thin,bottom color=orange!30, top color=white,
...
% In fact, no server is needed at all! It can by just a local folder.
% \begin{figure}
% 	\begin{tikzpicture}
% 	\tikzstyle{repository}=[rectangle, draw, burntorange, rounded corners,
% 	thin,bottom color=orange!30, top color=white,
...
% 	\node[repository] at (0,0) (repo1) {User 1};
% 	\node[workspace] at (0, -1.5) (ws1) {User 1};
...
% \end{frame}
    ...
    \framesubtitle{Seems like a time line}
    
    \begin{figure}
    	\begin{tikzpicture}
    	\tikzstyle{station}=[circle, black, draw, rounded corners,
    	ultra thick,color=black, minimum width=0.5cm]
    	\tikzstyle{line1}=[line width=0.1cm, blue]
    	\tikzstyle{line2}=[line width=0.1cm, red]
    	
    	\node[station, label={[rotate=45]north east:Commit 1}] at (0,0) (rev1) {};
    	\node[station, label={[rotate=45]north east:Commit 2}] at (2,0) (rev2) {};
    	\node[station, label={[rotate=45]north east:Commit 3}] at (4,0) (rev3) {};
    	\node[station, label={[rotate=45]north east:Commit 4}] at (6,0) (rev4) {};
    	\node[station, label={[rotate=45]north east:Commit 5}] at (8,0) (rev5) {};
    	
    	\draw[line1] (rev1) -- (rev2);
    	\draw[line1] (rev2) -- (rev3);
    	\draw[line1] (rev3) -- (rev4);
    	\draw[line1] (rev4) -- (rev5);
...
\begin{frame}{What is a repository?}
\framesubtitle{But it's more like a metro network}
...
\begin{figure}
	...
	\node[station] at (0,0) (rev1) {};
	\node[station] at (2,0) (rev2) {};
	\node[station] at (4,0) (rev3) {};
	\node[station] at (4,-1) (rev4) {};
	\node[station] at (6,0) (rev5) {};
	\node[station] at (8,0) (rev6) {};
	
	\draw[line2] (rev2) to[in=180,out=0] (rev4);
	\draw[line2] (rev4) -- (6, -1);
	\draw[line2] (6,-1) to[in=180,out=0] (rev6);
	\draw[line1] (rev1) -- (rev2);
	\draw[line1] (rev2) -- (rev3);
	\draw[line1] (rev3) -- (rev5);
	\draw[line1] (rev5) -- (rev6);
...
% \begin{frame}{See you at the lab}
	
% 13.00pm at Discord git-help (voice channel).

% Check the git-help text channel for any preparation instructions.
...
\begin{frame}{\texttt{git checkout main}}
\begin{figure}
\begin{subfigure}[b]{\textwidth}
	\centering
	\begin{tikzpicture}
